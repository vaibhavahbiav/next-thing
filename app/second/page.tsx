...
const SecondPage = () => {
  ...
  return (
    <div className='flex flex-col space-y-18 py-18 mx-52'>
      <h2 className='text-4xl uppercase text-cyan-950 font-medium tracking-widest text-left border-l-8 pl-5 border-teal-600 leading-loose'>All things to read that we had</h2>
      <h3 className='-mt-20 lowercase text-cyan-800 font-medium tracking-tighter text-left pl-7 border-teal-600 leading-loose'>&#91;at this moment...&#93;</h3>
